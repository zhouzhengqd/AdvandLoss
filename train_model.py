...
from models import  MNIST_target_net,MultiFocalLoss
import numpy as np
...
if __name__ == "__main__":
    ...
    for epoch in range(epochs):
        ...
        for i, data in enumerate(train_dataloader, 0):
            ...
            cri = MultiFocalLoss(10)
            loss_model = cri(logits_model, train_labels)
    ...
    # save model
    targeted_model_file_name = './MNIST_target_F1_model.pth'
